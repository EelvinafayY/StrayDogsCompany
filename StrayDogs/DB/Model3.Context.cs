...
namespace StrayDogs.DB
{
    ...
    public partial class Stray_DogsEntities3 : DbContext
    {
        public Stray_DogsEntities3()
            : base("name=Stray_DogsEntities3")
        {
        }
        ...
        public virtual DbSet<Priem_Status> Priem_Status { get; set; }
